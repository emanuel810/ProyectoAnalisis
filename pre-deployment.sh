...
git clone https://github.com/emanuel810/proyectofinal.git &&
cd proyectofinal &&
cd Frontend &&
...
cd .. &&
cd backend &&
echo DB_CNN="mongodb+srv://emanueldionicio809:GyZAnPPSIfF2NHr5@cluster0.ayocyoj.mongodb.net/test?retryWrites=true&w=majority" > .env &&
